    ...
    <>
      ...
      >
        <div className="h-full sm:mt-[250px] xsm:mt-[50px] flex flex-col gap-7 items-start flex-1">
          <h1 className="text-[5vw] font-bold text-secondary">I'm M.Hussain</h1>
          <div></div>
          <p className="text-paraColor text-[16px]">
            I'm a React js developer, My skills include HTML, CSS, Javascript
            and React js. As well as I have also knowledge of node js ,express
            and Mongodb
          </p>
          <a href="#work">
